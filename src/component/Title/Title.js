...
const Title = () => {
    return(
        <div className="title">
            <Link to="/"><h1 className="flex justify-center title logo">GW TOOLS</h1></Link>
             <div className="file-button-container">
                        <a className="file-button"  rel="noreferrer"y href={WpFile} download="WhitePapers 08.10.2022.docx">WHITE PAPRE FILE<br/><p className="small">last update: 2022 08 10</p></a>
