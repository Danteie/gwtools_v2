        ...
        <div className="title">
            <Link to="/"><h1 className="flex justify-center title">GW TOOLS</h1></Link>
             <div className="file-button-container">
                        <a className="file-button"  rel="noreferrer"y href={WpFile} download="WhitePapers 06.15.2022.docx">WHITE PAPRE FILE<br/><p className="small">last update: 2022 06 15</p></a>
